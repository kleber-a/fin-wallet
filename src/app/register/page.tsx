  ...
  return (
    ...
    // </div>
     ...
     <div className="flex min-h-screen flex-col items-center justify-center bg-gray-100 p-4">
      {/* Container principal do formulário: um card branco com sombra e cantos arredondados */}
      <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-xl shadow-2xl">
        <div className="flex flex-col items-center space-y-4 text-center">
          {/* Logo da FinWallet */}
          <Link href="/" className="flex items-center justify-center mb-4">
            <Wallet className="h-10 w-10 text-green-600" /> {/* Ícone maior e na cor da marca */}
            <span className="ml-3 text-3xl font-extrabold text-gray-900">FinWallet</span> {/* Nome da marca em destaque */}
          </Link>
        ...
        {/* Componente do formulário de registro (RegisterForm) */}
        <RegisterForm />
